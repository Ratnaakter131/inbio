            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="m-0 text-center">Add Education</h5>
                    </div>
                    <div class="card-body">
                        <form action="education_add_process.php" method="POST">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="course" name="course" value="<?= show_session_data('course') ?>">
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="institute" name="institute" value="<?= show_session_data('institute') ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-sm" name="add">Add Education</button>
                            </div>
                        </form>
                    </div>
                </div>
